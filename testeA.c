...
int main() {
    ...
    while (executando) {
        ...
        if (dataButton == 0b01) {
            ...
            // Atraso para evitar múltiplas detecções de um clique
            usleep(300000); // 300ms de atraso
        }
        ...
        // Um pequeno atraso entre as iterações do loop para evitar que a CPU fique sobrecarregada
        usleep(20000); // 20ms de atraso
    }
